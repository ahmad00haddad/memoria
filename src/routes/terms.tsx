...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "الشروط والأحكام — EliteCapture" },
      { name: "description", content: "شروط استخدام منصة EliteCapture لحجوزات مصوّرات الأعراس في الأردن: الحجز، العربون، الإلغاء، والتسليم." },
    ],
  }),
  component: TermsPage,
});
      ...
      <main className="container-editorial py-12 max-w-3xl">
        ...
        <section className="space-y-6 leading-loose">
          <Block t="1. طبيعة المنصة">
            EliteCapture منصة تنظيمية تربط العميلات بمصوّرات الأعراس في الأردن. المنصة ليست طرفاً في عقد التصوير نفسه؛ العقد يُبرم مباشرة بين العميلة والمصوّرة.
          </Block>
